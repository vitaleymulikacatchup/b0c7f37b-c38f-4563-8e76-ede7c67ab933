...
export const metadata: Metadata = {
  title: "AI SaaS Platform - Transform Your Business with AI",
  description: "Unlock the power of AI to automate workflows, analyze data, and accelerate business growth. Join 10K+ companies using our intelligent platform.",
  keywords: "AI platform, business automation, machine learning, SaaS, artificial intelligence, data analytics, workflow automation",
  metadataBase: new URL("https://aisaas.com"),
  alternates: {
    canonical: "https://aisaas.com"
  },
  openGraph: {
    title: "AI SaaS Platform - Transform Your Business with AI",
    description: "Unlock the power of AI to automate workflows, analyze data, and accelerate business growth. Join 10K+ companies using our intelligent platform.",
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/9783346/pexels-photo-9783346.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "AI dashboard interface showing analytics and automation"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "AI SaaS Platform - Transform Your Business with AI",
    description: "Unlock the power of AI to automate workflows, analyze data, and accelerate business growth. Join 10K+ companies using our intelligent platform.",
    images: ["https://images.pexels.com/photos/9783346/pexels-photo-9783346.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
